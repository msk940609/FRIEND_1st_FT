...
ft_comp_soa$rel=round(ft_comp_soa$cnt/ft_comp_soa$tot*100,5)
...
FT_envi_sel
FT_envi_sel2=FT_envi_sel[,c("Sample","Group","No","PM2.5","WSOCbb","WSOCnbb")]
...
ft_comp_merge=ft_comp_merge[,c("Sample","Group","No","PM2.5","WSOCnbb","CHO","CHON","CHOS","CHONS",
...
tiff(filename = "UL_cor_all.tiff", width = 20,height = 20, units = "cm",res = 300)
...
tiff(filename = "UL_cor_SOC.tiff", width = 20,height = 20, units = "cm",res = 300)
chart.Correlationx(ft_comp_merge_ul[,-c("Sample","Group","No","WSOCbb","CHO (WSOCbb)","CHON (WSOCbb)","CHOS (WSOCbb)",
...
tiff(filename = "bj_cor_all.tiff", width = 20,height = 20, units = "cm",res = 300)
...
tiff(filename = "bj_cor_SOC.tiff", width = 20,height = 20, units = "cm",res = 300)
chart.Correlationx(ft_comp_merge_bj[,-c("Sample","Group","No","WSOCbb","CHO (WSOCbb)","CHON (WSOCbb)","CHOS (WSOCbb)",
                                        "CHONS (WSOCbb)","CHO","CHON","CHOS",
                                        "CHONS")],
                   method = "spearman",exact=F, labels=conlab,label.pos=0.65,blk=2.5)
...
tiff(filename = "ss_cor_all.tiff", width = 20,height = 20, units = "cm",res = 300)
...
tiff(filename = "ss_cor_SOC.tiff", width = 20,height = 20, units = "cm",res = 300)
chart.Correlationx(ft_comp_merge_ss[,-c("Sample","Group","No","WSOCbb","CHO (WSOCbb)","CHON (WSOCbb)","CHOS (WSOCbb)",
                                        "CHONS (WSOCbb)","CHO","CHON","CHOS",
                                        "CHONS")],
                   method = "spearman",exact=F, labels=conlab,label.pos=0.65,blk=2.5)
...
tiff(filename = "sul_cor_all.tiff", width = 20,height = 20, units = "cm",res = 300)
...
tiff(filename = "sul_cor_SOC.tiff", width = 20,height = 20, units = "cm",res = 300)
chart.Correlationx(ft_comp_merge_sul[,-c("Sample","Group","No","WSOCbb","CHO (WSOCbb)","CHON (WSOCbb)","CHOS (WSOCbb)",
                                         "CHONS (WSOCbb)","CHO","CHON","CHOS",
                                         "CHONS")],
                   method = "spearman",exact=F, labels=conlab,label.pos=0.65,blk=2.5)
...
tiff(filename = "nt_cor_all.tiff", width = 20,height = 20, units = "cm",res = 300)
...
tiff(filename = "nt_cor_SOC.tiff", width = 20,height = 20, units = "cm",res = 300)
chart.Correlationx(ft_comp_merge_nt[,-c("Sample","Group","No","WSOCbb","CHO (WSOCbb)","CHON (WSOCbb)","CHOS (WSOCbb)",
                                        "CHONS (WSOCbb)","CHO","CHON","CHOS",
                                        "CHONS")],
                   method = "spearman",exact=F, labels=conlab,label.pos=0.65,blk=2.5)
...
ft_comp_merge_nt[,-c("Sample","Group","No","WSOCbb","CHO (WSOCbb)","CHON (WSOCbb)","CHOS (WSOCbb)",
                     "CHONS (WSOCbb)")]
ft_comp_cor=ft_comp_merge[,-c("WSOCbb","CHO (WSOCbb)","CHON (WSOCbb)","CHOS (WSOCbb)",
                              "CHONS (WSOCbb)")]
...
#fwrite(dt,file = "cor_NBBvsComp.csv")
dt=fread("Datafile/cor_NBBvsComp.csv")
...
ggplot(dt, aes(x=Comp,y=rho,fill=Type))+
  ...
  theme(panel.grid = element_blank(),
        ...
        legend.text = element_text(size = 16,face=2, hjust=0.5,colour = "black",margin = unit(c(0.2,0.2,0.2,0.0),"cm")),
  ...
  ggsave(filename("rho_comp_NBB_bar"),height = 13, width = 60, units = "cm", dpi = 300)
...
d0$Type=ifelse(is.na(d0$type),"All","SOC")
...
ggplot(d0, aes(x=envi,y=rho,fill=Type))+
  ...
  guides(fill=guide_legend(title = NULL,title.hjust = 0.5))+
  ggsave(filename("rho_comp_envi"),height = 22, width = 45, units = "cm", dpi = 300)
