...
ft_envi=fread("Datafile/FRIEND_1st_envi_re_ex.csv")
...
tiff(filename = "UL_cor_all_ex.tiff", width = 20,height = 20, units = "cm",res = 300)
...
tiff(filename = "ss_cor_all_p.tiff", width = 20,height = 20, units = "cm",res = 300)
chart.Correlationx(ft_comp_merge_ss[,-c("Sample","Group","No","WSOCbb","CHO (WSOCbb)","CHON (WSOCbb)","CHOS (WSOCbb)",
                                        "CHONS (WSOCbb)","CHO (WSOCnbb)","CHON (WSOCnbb)","CHOS (WSOCnbb)",
                                        "CHONS (WSOCnbb)")],
                   method = "pearson",exact=F, labels=conlab,label.pos=0.65,blk=2.5)
dev.off()
